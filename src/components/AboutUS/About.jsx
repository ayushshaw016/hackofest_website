...
const AboutUS = () => {
  return (
    <>
    <div className="ml-8 px-32 text-white  mt-20 text-2xl font-bold font-serif lg:w-1/2">
 ...
 <br/><br/>
        <div className="ml-8 px-32 text-white  text-2xl font-bold font-serif lg:w-1/2 float-right my-8">
        <div className="p-4 border-white border-solid border-2 rounded-xl">
