...
const AboutUS = () => {
  return (
    ...
    <div className="ml-8 px-32 text-white  mt-20 text-2xl font-bold font-serif md:w-1/2"  data-aos="fade-right" data-aos-delay="300">
 ...
 <br/><br/>
        <div className="ml-8 px-32 text-white  text-2xl font-bold font-serif md:w-1/2 float-right mt-20"  data-aos="fade-left" data-aos-delay="300">
        <div className="p-4 border-white border-solid border-2 rounded-xl">
